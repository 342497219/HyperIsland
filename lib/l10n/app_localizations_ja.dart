...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get note2 =>
      '2. HyperCeiler でシステム UI と MIUI フレームワークのフォーカス通知のホワイトリストを无効化してください。';
  ...
  @override
  String get appDisabledBanner => 'アプリが無効化されているため、以下のチャンネル設定は无効です';
  ...
  @override
  String get aiConfigSubtitleDisabled => '无効 · タップで構成';
